...
class F1Dataset(Dataset):
    ...
    def __init__(self, data_file_path):
        self.feature_columns = ["Year", "Round", "RoundsCompleted", "RoundsRemaining", "AvgGridPosition", "AvgPosition", 
                                "DNFRate", "AvgPointsPerRace", "TotalPointFinishes", "TotalPodiums", "TotalPoints", 
                                "hadPenaltyThisYear", "CurrentRankAfterRound"]
        self.skewed_feature_columns = ["DNFRate", "TotalPointFinishes", "TotalPodiums", "TotalPoints", "hadPenaltyThisYear", \
                                       "CurrentRankAfterRound"]
