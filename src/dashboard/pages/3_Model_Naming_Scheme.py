...
st.subheader("3. Suzuka")
st.markdown("""
- Specialized in mid-field (for v1 and v2 generations) and lower-ranking (for v3 generation) prediction accuracy
- Just as Suzuka's figure-eight circuit tests precision and technical balance, these models shine in complex mid-grid dynamics
""")

st.subheader("4. Spa-Franocorchamps")
st.markdown("""
